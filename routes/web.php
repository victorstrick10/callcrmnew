...
Route::post('/clients/refresh-geo', [ClientController::class, 'refreshGeoOne'])->name('clients.refresh-geo');
...
Route::post('/static-proxies/delete-down', [StaticProxyController::class, 'deleteDown'])->name('static-proxies.delete-down');
