...
class ProfileNameFormatterTest extends TestCase
{
    public function test_geo_name(): void
    {
        ...
        $this->assertSame(
            '002 - Ana Black Diligent GEO United States Texas Austin',
            $f->geo(2, 'Ana Black', 'Diligent', 'United States', 'Texas', 'Austin')
        );
    }
    ...
    {
        $f = new ProfileNameFormatter();
        $this->assertSame('003 - Ana Black Global STATIC US Texas', $f->staticName(3, 'Ana Black', 'Global', 'US', 'Texas', ''));
    }
